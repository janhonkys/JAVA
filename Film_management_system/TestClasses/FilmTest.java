...
class FilmTest {
    ...
    @Test
    void testSetFilmYearBoundary() {
        // Test boundary values for film year
        film.setYear(1900);
        assertEquals(1900, film.getYear(), "Year should be set to 1900");

        film.setYear(2030);
        assertEquals(2030, film.getYear(), "Year should be set to 2030");
    }

    @Test
    void testSetInvalidFilmYear() {
        // Test setting invalid film years
        assertThrows(IllegalArgumentException.class, () -> film.setYear(1899), "Year below 1900 should throw IllegalArgumentException");
        assertThrows(IllegalArgumentException.class, () -> film.setYear(2031), "Year above 2030 should throw IllegalArgumentException");
    }
