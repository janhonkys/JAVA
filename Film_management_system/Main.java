...
import projektPC2_designpatterns.FilmFactory.AFilmFactory;
import projektPC2_designpatterns.FilmFactory.FilmFactory;
import projektPC2_designpatterns.FilmFactory.HFilmFactory;
...
/**
 ...
 Users can perform actions such as managing films, actors, and their details.
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        addFilmToActor(newAFilm, newActor);
        addFilmToActor(newAFilm1, newActor);
        addFilmToActor(newHFilm, newActor1);
        addFilmToActor(newHFilm1, newActor1);

        // Adding reviews to films
        newAFilm.addReview(10);
        newAFilm.addReview(9);
        newHFilm.addReview(3);
        newHFilm.addReview(4);
        ...
        while (run) {
            ...
            switch (choice3) {
                case 1:
                    ...
                    Film info = findFilmByName(); // Find the selected film
                ...
                case 2:
                    // Edit film details
                    Film filmToUpdate = findFilmByName(); // Find the film to be edited
                    filmList.remove(filmToUpdate.getName()); // Remove the film from the database to update its details
                    System.out.println("Enter a new name of the film:");
                ...
                case 3:
                    ...
                    Film filmToDelete = findFilmByName(); // Find the film to be deleted
                ...
                case 4:
                    ...
                    Film film = findFilmByName(); // Find the film to add a review
                ...
                case 5:
                    ...
                    if (filmList.isEmpty()) {
                        ...
                        for (Film theFilm : filmList.values()) {
                            theFilm.printInfo(); // Print basic information about each film
                        }
                    }
                    break;
                ...
                case 6:
                    ...
                    Film newFilm;
                    if (choice == 1) {
                        factory = new HFilmFactory();
                        newFilm = factory.createFilm(filmName, directorName, year); // Create a new feature film
                    } else {
                        System.out.println("Enter the recommended age of the viewers:");
                        factory = new AFilmFactory();
                        newFilm = factory.createFilm(filmName, directorName, year); // Create a new animated film
                    }
                ...
                case 9:
                    ...
                    Film filmToSave = findFilmByName(); // Find the film to save
                ...
                case 11:
                    ...
                    Film film2 = findFilmByName(); // Find the film
                    Actor actor2;
                ...
                case 12:
                    ...
                    Film findFilm4 = findFilmByName(); // Find the film
    ...
    private static Actor findActor() {
        ...
        Actor actor = null;
        while (actor == null) {
            System.out.println("Enter actor/animator name:"); // Prompt the user to enter the actor's name
            String actorName = Inputs.onlyName(); // Get the actor's name
            System.out.println("Enter actor/animator surname:"); // Prompt the user to enter the actor's surname
    ...
    private static Film findFilmByName() {
    ...
    public static void addFilmToActor(Film film, Actor actor) {
        film.addActor(actor);
        actor.addFilm(film);
    }

    // Method removes a film from the actor's list of films and removes the actor from the film's list of actors.
    public static void removeFilmFromActor(Film film, Actor actor) {
