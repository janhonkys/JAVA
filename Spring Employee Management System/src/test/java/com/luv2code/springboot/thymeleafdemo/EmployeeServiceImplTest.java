...
class EmployeeServiceImplTest {
    ...
    void testGetAgeDistribution() {
        // Define behavior for mocked repository
        when(employeeRepository.countEmployeesByAgeLessThan(20)).thenReturn(3L);
        when(employeeRepository.countEmployeesByAgeBetween(20, 40)).thenReturn(10L);
        when(employeeRepository.countEmployeesByAgeBetween(40, 60)).thenReturn(7L);
        when(employeeRepository.countEmployeesByAgeGreaterThanEqual(60)).thenReturn(2L);
        ...
        verify(employeeRepository, times(1)).countEmployeesByAgeLessThan(20);
        verify(employeeRepository, times(1)).countEmployeesByAgeBetween(20, 40);
        verify(employeeRepository, times(1)).countEmployeesByAgeBetween(40, 60);
        verify(employeeRepository, times(1)).countEmployeesByAgeGreaterThanEqual(60);
    }
}
