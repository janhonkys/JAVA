...
public class Main {
    static TreeMap<String, Film> list = new TreeMap<String, Film>();
    ...
    public static void main(String[] args) {
        ...
        while(run) {
            ...
            int volba = Inputs.pouzeCislo(1, 12);
            switch (volba) {
                case 1:
                    Film info = findfilm();
                ...
                case 2:
                    ...
                    list.remove(info1.getName());
                        if (info1 instanceof HFilm) {
                            ...
                            int in4 = Inputs.pouzeCislo(0, 2024);
                            info1.setName(in2);
                            ...
                            int in5 = Inputs.pouzeCislo(0, 100);
                            info1.setName(in2);
                            info1.setDirector(in3);
                            info1.setYear(in4);
                ...
                case 4:
                    ...
                    if (info4 instanceof HFilm) {
                         ...
                         int in8 = Inputs.pouzeCislo(1, 5);
                         info4.addReview(in8);
                    } else {
                         System.out.println("Zadejte bodové hodnocení 1-10:");
                         int in9 = Inputs.pouzeCislo(1, 10);
                         info4.addReview(in9);
                    }
                    break;
                ...
                case 6:
                    ...
                    System.out.println("Zadejte rok vydání:");
                    int int4 = Inputs.pouzeCislo(0, 2024);
                    if (in8 == 1) {
                        HFilm f = new HFilm(in2, in30, int4);
                        list.put(f.getName(), f);
                    } else {
                        System.out.println("Zadejte doporučený věk diváků:");
                        int int5 = Inputs.pouzeCislo(0, 100);
                ...
                case 11:
                    ...
                    int in15 = Inputs.pouzeCislo(1, 2);
                    if (in15 == 1) {
                        System.out.println("Zadejte jméno herce/animátora:");
